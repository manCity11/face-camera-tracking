...
const scriptsLint = async (cb) => {
  try {
    ...
    if (errors > 0 || warnings > src.reports.maxWarnings) {
      ...
      warnings > src.reports.maxWarnings && console.error(`Failed because of too many warnings. Found ${warnings} warnings, threshold is ${src.reports.maxWarnings}.`); // eslint-disable-line
...
module.exports = { scriptsLint, stylesLint };
